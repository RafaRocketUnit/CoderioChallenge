...
data class MoviesEntityTopRated(
...
fun Movies.toMoviesEntityTopRated(): MoviesEntityTopRated {
    ...
    return MoviesEntityTopRated(dates = dates, page = this.page, results = result, total_pages = this.total_pages, total_results = this.total_results)
}
